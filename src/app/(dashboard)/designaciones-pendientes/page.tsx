...
export default async function DesignacionesPendientesPage() {
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="page-title mt-2">Designaciones pendientes</h1>
        </div>
      </div>
      ...
      <Card className="border-amber-500/20">
        <CardHeader>
          ...
          <CardDescription>
            {pending.length === 0
              ? "No tienes designaciones pendientes de aceptar"
              : `Pulsa "Aceptar" en cada designación para aceptarla y descargar el PDF`}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {pending.length === 0 ? (
